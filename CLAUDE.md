...
- **Шкала 1–35 см, распределение равномерное.** У каждого значения одинаковый шанс,
  края выпадают не реже середины. Раньше был колокол (среднее трёх равномерных величин)
  с пиком на 17–20 см; 8 августа 2026 владелец заменил его на ровный рандом — редкие
  крайние значения оказались интереснее предсказуемой середины.
